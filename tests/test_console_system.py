...
from src.test_mcp.shared.console_shared import MCPConsole, get_console, MessageType
...
class TestMCPConsole:
    ...
    def test_error_with_suggestions(self):
        ...
        with patch.object(console.console, 'print') as mock_print:
            ...
            assert mock_print.call_count == 4  # Error + suggestions header + 2 suggestions
